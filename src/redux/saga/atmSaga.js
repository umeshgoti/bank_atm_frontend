...
import { ADD_ATM_REQUEST, addAtmFailure, FETCH_ATM_REQUEST, fetchAtmFailure, fetchAtmRequest, fetchAtmSuccess } from "../action/atmAction";
import Api from "../../api";
...
function* fetchAtmData() {
    try {
        const response = yield call(api.getAPI, `api/atm`);
